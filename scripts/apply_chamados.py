"""
scripts/apply_chamados.py — Aplica a migration 008 do módulo de chamados.
...
if __name__ == '__main__':
    ...
    with app.app_context():
        print("Aplicando migration 008 (chamados)...")
        with acquire_conn() as conn:
            with conn.cursor() as cur:
                cur.execute(SQL)
            conn.commit()
        print("Concluído! Tabelas 'chamados' e 'chamado_mensagens' criadas.")
